...
<head>
	<meta charset="utf-8">
	<title>Administración <?php echo $local_nombre ?> - Concert Manager</title>
...
<div class="ui middle aligned center aligned grid">
	...
	<div class="column">
		...
		<h3 class="top attached header">
			Administrar <?php echo $local_nombre ?>
		</h3>
		
	  	<div class="ui attached piled segment">

	  		<form class="ui form error" method="post" action="<?php echo site_url("local/editar");?>">
				<div class="field">
					<div class="ui input">
						<input type="text" name="nombre" value="<?php echo $local_nombre ?>" autofocus>
						<input type="hidden" name="id" value="<?php echo $local_id ?>" autofocus>					
					</div>
				</div>
				<div class="field">					
